...
This can be further automated, but this is the procedure used for the v0.0.4 release.
...
Use the Release URLs from "Get Release URLs" and the SHA-512s to update `nixos.yaml` in `nixos-lima/nixos-lima-config-sample`
